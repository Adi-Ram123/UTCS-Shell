...
SRCS = utcsh.c util.c 
SIGSRCS = mykill.c handle.c sig_util.c 
HEADERS = util.h
SIGHEADERS = util.h
FILES = $(SRCS) $(HEADERS)
...
handle: handle.o sig_util.o
	$(CC) $(CFLAGS) handle.o sig_util.o -o handle

mykill: mykill.o sig_util.o
	$(CC) $(CFLAGS) mykill.o sig_util.o -o mykill
...
HANDOUT_FILES = examples/ tests/\
 ...
 mykill.c handle.c sig_util.c sig_util.h
